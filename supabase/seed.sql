-- Seed script: paste and run this entire file in the Supabase SQL Editor
...
BEGIN
  ...
  LOOP
    ...
    INSERT INTO companies (name, domain, industry, verified)
    VALUES (rec->>'name', rec->>'domain', rec->>'industry', true)
